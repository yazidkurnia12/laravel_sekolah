       ...
       <div class="container-fluid">
           ...
           <div id="navbar-menu">
               <ul class="nav navbar-nav navbar-right">
                   ...
                   <li class="dropdown">
                       <a href="#" class="dropdown-toggle" data-toggle="dropdown"><img @if (auth()->user()->avatar == null)
                           src="{{ asset('images/default.jpg') }}"
                       @else
                           src="{{ asset('images/' . auth()->user()->avatar) }}"

                           @endif class="img-circle" alt="Avatar" style="width: 30px; height:
                           30px;">
                           <span>
                               {{--
                               untuk mengambil nama user yg login karena kita telah menggunakan
                               helper auth bawaan laravel maka kita dapat memanggil nama dari user
                               yang sedang login dengan menggunakan laravel
                               yaitu auth()->user()->fieldkolom
                               --}}
                               {{ auth()->user()->name }}
                       ...
                       <ul class="dropdown-menu">
                           ...
                           <li><a href="{{ url('/auth/logout') }}"><i class="lnr lnr-exit"></i> <span>Logout</span></a>
                           </li>
                       </ul>
                   </li>
               </ul>
